...
public class Project extends JFrame implements ActionListener{
    Project(){
        ...
        Image i3 = ic.getImage().getScaledInstance(1670, 900,Image.SCALE_DEFAULT);
        ImageIcon icc3 = new ImageIcon(i3);
        JLabel l1 = new JLabel(icc3);
        
        add(l1);
        
        JMenuBar mb  = new JMenuBar();  //Making Menu Bar 

        JMenu master = new JMenu("Admin");  // Making Admin Look

        //Making menu items 
        JMenuItem m1 = new JMenuItem("New Faculty"); 
        JMenuItem m2 = new JMenuItem("New Student");

        master.setForeground(Color.BLUE);  //Changing color
        
        
        m1.setFont(new Font("monospaced",Font.BOLD,16));  //Adding image and fonts
  ...
  //Details Menu
        ...
        ImageIcon icon5 = new ImageIcon(ClassLoader.getSystemResource("university/management/system/icons/icon4.png"));
        ...
        ImageIcon icon23 = new ImageIcon(ClassLoader.getSystemResource("university/management/system/icons/icon14.png"));
        ...
        ImageIcon icon29 = new ImageIcon(ClassLoader.getSystemResource("university/management/system/icons/icon14.png"));
        ...
        Image image31 = icon30.getImage().getScaledInstance(30, 30,Image.SCALE_DEFAULT);
        ...
        Image image33 = icon32.getImage().getScaledInstance(30, 30,Image.SCALE_DEFAULT);
        ...
        Image image15 = icon14.getImage().getScaledInstance(22, 22,Image.SCALE_DEFAULT);
        ...
        Image image17 = icon16.getImage().getScaledInstance(22, 22,Image.SCALE_DEFAULT);
        ...
        ImageIcon icon21 = new ImageIcon(ClassLoader.getSystemResource("university/management/system/icons/icon13.png"));
