...
class AddStudent implements ActionListener{
    ...
    public AddStudent(){
        ...
        id15.setLayout(null);
       ImageIcon img = new ImageIcon(ClassLoader.getSystemResource("university/management/system/icons/forth.jpg"));
	...
	lab2.setFont(new Font("serif",Font.BOLD,20));
        ...
        String branch[] = {"Computer Science","Electronics","Electrical","Mechanical","Civil","Plain","BioTech","None"};
